...
3. **geNomad larger scale validation:** expand the five-genome positive-call Docker/GHCR validation to 10+ genomes with `--genomad_splits` tuned for memory.

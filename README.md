...
| `--panr2_update_abricate_db` | bool | false | Force-refresh requested ABRicate databases with `abricate-get_db --force` after setup when available |

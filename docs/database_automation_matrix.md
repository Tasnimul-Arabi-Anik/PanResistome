...
2. **geNomad positive-call validation**, using a prophage-rich dataset to confirm non-empty `prophage.features.tsv` rows after the Docker DB-download/runner path.
